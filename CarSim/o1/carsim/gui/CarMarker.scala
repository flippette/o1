...
class CarMarker(val map: CarMap, val car: CarEnhancement) extends Marker(/*layer=*/ swingops.Null, /*name=*/ swingops.Null, car.location, /*radius=*/ 5, MapMarker.STYLE.FIXED, CarMarker.fuelStyle(car)):
...
private object CarMarker:
  ...
  def fuelStyle(car: CarEnhancement) = Style(Color.black, fuelColor(car), /*stroke=*/ Null, /*font=*/ Null)
end CarMarker
